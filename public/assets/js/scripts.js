...
! function(a) {
    ...
    $.extend($.fn, {
        validate: function(b) {
            ...
            var a = $.data(this[0], "validator");
            return a || (this.attr("novalidate", "novalidate"), a = new $.validator(b, this[0]), $.data(this[0], "validator", a), a.settings.onsubmit && (this.on("click.validate", ":submit", function(b) {
                a.submitButton = b.currentTarget, $(this).hasClass("cancel") && (a.cancelSubmit = !0), void 0 !== $(this).attr("formnovalidate") && (a.cancelSubmit = !0)
            }), this.on("submit.validate", function(c) {
                function b() {
                    var b, d;
                    return a.submitButton && (a.settings.submitHandler || a.formSubmitted) && (b = $("<input type='hidden'/>").attr("name", a.submitButton.name).val($(a.submitButton).val()).appendTo(a.currentForm)), !a.settings.submitHandler || !!a.settings.debug || (d = a.settings.submitHandler.call(a, a.currentForm, c), b && b.remove(), void 0 !== d && d)
                }
                return (a.settings.debug && c.preventDefault(), a.cancelSubmit) ? (a.cancelSubmit = !1, b()) : a.form() ? a.pendingRequest ? (a.formSubmitted = !0, !1) : b() : (a.focusInvalid(), !1)
            }))), a
        },
        valid: function() {
            var a, b, c;
            return $(this[0]).is("form") ? a = this.validate().form() : (c = [], a = !0, b = $(this[0].form).validate(), this.each(function() {
                (a = b.element(this) && a) || (c = c.concat(b.errorList))
            }), b.errorList = c), a
        },
        rules: function(h, c) {
            var f, g, d, b, e, i, a = this[0],
                j = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
            if (null != a && (!a.form && j && (a.form = this.closest("form")[0], a.name = this.attr("name")), null != a.form)) {
                if (h) switch (g = (f = $.data(a.form, "validator").settings).rules, d = $.validator.staticRules(a), h) {
                    case "add":
                        $.extend(d, $.validator.normalizeRule(c)), delete d.messages, g[a.name] = d, c.messages && (f.messages[a.name] = $.extend(f.messages[a.name], c.messages));
                        break;
                    case "remove":
                        if (!c) return delete g[a.name], d;
                        return i = {}, $.each(c.split(/\s/), function(b, a) {
                            i[a] = d[a], delete d[a]
                        }), i
                }
                return (b = $.validator.normalizeRules($.extend({}, $.validator.classRules(a), $.validator.attributeRules(a), $.validator.dataRules(a), $.validator.staticRules(a)), a)).required && (e = b.required, delete b.required, b = $.extend({
                    required: e
                }, b)), b.remote && (e = b.remote, delete b.remote, b = $.extend(b, {
                    remote: e
                })), b
            }
        }
    ...
    $.extend($.expr.pseudos || $.expr[":"], {
        ...
        this.settings = $.extend(!0, {}, $.validator.defaults, a), this.currentForm = b, this.init()
    }, $.validator.format = function(b, a) {
        return 1 === arguments.length ? function() {
            var a = $.makeArray(arguments);
            return a.unshift(b), $.validator.format.apply(this, a)
        } : (void 0 === a || (arguments.length > 2 && a.constructor !== Array && (a = $.makeArray(arguments).slice(1)), a.constructor !== Array && (a = [a]), $.each(a, function(a, c) {
        ...
        defaults: {
            ...
            onkeyup: function(a, b) {
                (9 !== b.which || "" !== this.elementValue(a)) && -1 === $.inArray(b.keyCode, [16, 17, 18, 20, 35, 36, 37, 38, 39, 40, 45, 144, 225]) && (a.name in this.submitted || a.name in this.invalid) && this.element(a)
            },
            onclick: function(a) {
        ...
        prototype: {
            init: function() {
                ...
                var a, c = this.currentForm,
                    d = this.groups = {};

                function b(b) {
                    var f = void 0 !== $(this).attr("contenteditable") && "false" !== $(this).attr("contenteditable");
                    if (!this.form && f && (this.form = $(this).closest("form")[0], this.name = $(this).attr("name")), c === this.form) {
                        var d = $.data(this.form, "validator"),
                            e = "on" + b.type.replace(/^validate/, ""),
                            a = d.settings;
                        a[e] && !$(this).is(a.ignore) && a[e].call(d, this, b)
                    }
                }
                $.each(this.settings.groups, function(b, a) {
                    "string" == typeof a && (a = a.split(/\s/)), $.each(a, function(c, a) {
                        d[a] = b
                    })
                }), a = this.settings.rules, $.each(a, function(b, c) {
                    a[b] = $.validator.normalizeRule(c)
                }), $(this.currentForm).on("focusin.validate focusout.validate keyup.validate", ":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'], [type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox'], [contenteditable], [type='button']", b).on("click.validate", "select, option, [type='radio'], [type='checkbox']", b), this.settings.invalidHandler && $(this.currentForm).on("invalid-form.validate", this.settings.invalidHandler)
            },
            form: function() {
            ...
            element: function(d) {
                var b, f, e = this.clean(d),
                    a = this.validationTargetFor(e),
                    g = this,
                    c = !0;
                return void 0 === a ? delete this.invalid[e.name] : (this.prepareElement(a), this.currentElements = $(a), (f = this.groups[a.name]) && $.each(this.groups, function(b, d) {
                    d === f && b !== a.name && (e = g.validationTargetFor(g.clean(g.findByName(b)))) && e.name in g.invalid && (g.currentElements.push(e), c = g.check(e) && c)
                }), b = !1 !== this.check(a), c = c && b, b ? this.invalid[a.name] = !1 : this.invalid[a.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), $(d).attr("aria-invalid", !b)), c
            },
            showErrors: function(a) {
                if (a) {
                    var b = this;
                    $.extend(this.errorMap, a), this.errorList = $.map(this.errorMap, function(a, c) {
                        return {
                            message: a,
                            element: b.findByName(c)[0]
                        }
                    }), this.successList = $.grep(this.successList, function(b) {
                        return !(b.name in a)
                    })
                }
            ...
            resetElements: function(b) {
                ...
                if (this.settings.unhighlight)
                    for (a = 0; b[a]; a++) this.settings.unhighlight.call(this, b[a], this.settings.errorClass, ""), this.findByName(b[a].name).removeClass(this.settings.validClass);
            ...
            findLastActive: function() {
                ...
                return a && 1 === $.grep(this.errorList, function(b) {
            ...
            elements: function() {
                ...
                return $(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    var c = this.name || $(this).attr("name"),
                        d = void 0 !== $(this).attr("contenteditable") && "false" !== $(this).attr("contenteditable");
                    return !c && a.settings.debug && window.console && console.error("%o has no name assigned", this), d && (this.form = $(this).closest("form")[0], this.name = c), this.form === a.currentForm && !(c in b) && !!a.objectLength($(this).rules()) && (b[c] = !0, !0)
                })
            },
            clean: function(a) {
                return $(a)[0]
            ...
            elementValue: function(b) {
                var a, e, c = $(b),
                    d = b.type,
                    f = void 0 !== c.attr("contenteditable") && "false" !== c.attr("contenteditable");
                return "radio" === d || "checkbox" === d ? this.findByName(b.name).filter(":checked").val() : "number" === d && void 0 !== b.validity ? b.validity.badInput ? "NaN" : c.val() : (a = f ? c.text() : c.val(), "file" === d) ? "C:\\fakepath\\" === a.substr(0, 12) ? a.substr(12) : (e = a.lastIndexOf("/")) >= 0 || (e = a.lastIndexOf("\\")) >= 0 ? a.substr(e + 1) : a : "string" == typeof a ? a.replace(/\r/g, "") : a
            },
            check: function(a) {
                a = this.validationTargetFor(this.clean(a));
                var d, e, c, f, b = $(a).rules(),
                    j = $.map(b, function(b, a) {
                        return a
                    }).length,
                    h = !1,
                    i = this.elementValue(a);
                for (e in "function" == typeof b.normalizer ? f = b.normalizer : "function" == typeof this.settings.normalizer && (f = this.settings.normalizer), f && (i = f.call(a, i), delete b.normalizer), b) {
                    c = {
                        method: e,
                        parameters: b[e]
                    };
                    try {
                        if (d = $.validator.methods[e].call(this, i, a, c.parameters), "dependency-mismatch" === d && 1 === j) {
                            h = !0;
                            continue
                        }
                        if (h = !1, "pending" === d) {
                        ...
                        if (!d) return this.formatAndAdd(a, c), !1
                    } catch (g) {
                        throw this.settings.debug && window.console && console.log("Exception occurred when checking element " + a.id + ", check the '" + c.method + "' method.", g), g instanceof TypeError && (g.message += ".  Exception occurred when checking element " + a.id + ", check the '" + c.method + "' method."), g
                    }
                }
                if (!h) return this.objectLength(b) && this.successList.push(a), !0
            },
            ...
            defaultMessage: function(c, a) {
                ...
                var b = this.findDefined(this.customMessage(c.name, a.method), this.customDataMessage(c, a.method), !this.settings.ignoreTitle && c.title || void 0, $.validator.messages[a.method], "<strong>Warning: No message defined for " + c.name + "</strong>"),
                    d = /\$?\{(\d+)\}/g;
                return "function" == typeof b ? b = b.call(this, a.parameters, c) : d.test(b) && (b = $.validator.format(b.replace(d, "{$1}"), a.parameters)), b
            },
            ...
            showLabel: function(b, f) {
                var c, i, e, h, a = this.errorsFor(b),
                    g = this.idOrName(b),
                    d = $(b).attr("aria-describedby");
                a.length ? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(f)) : (c = a = $("<" + this.settings.errorElement + ">").attr("id", g + "-error").addClass(this.settings.errorClass).html(f || ""), this.settings.wrapper && (c = a.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length ? this.labelContainer.append(c) : this.settings.errorPlacement ? this.settings.errorPlacement.call(this, c, $(b)) : c.insertAfter(b), a.is("label") ? a.attr("for", g) : 0 === a.parents("label[for='" + this.escapeCssMeta(g) + "']").length && (e = a.attr("id"), d ? d.match(new RegExp("\\b" + this.escapeCssMeta(e) + "\\b")) || (d += " " + e) : d = e, $(b).attr("aria-describedby", d), (i = this.groups[b.name]) && (h = this, $.each(h.groups, function(b, c) {
                    c === i && $("[name='" + h.escapeCssMeta(b) + "']", h.currentForm).attr("aria-describedby", a.attr("id"))
                })))), !f && this.settings.success && (a.text(""), "string" == typeof this.settings.success ? a.addClass(this.settings.success) : this.settings.success(a, b)), this.toShow = this.toShow.add(a)
            },
            errorsFor: function(b) {
                var c = this.escapeCssMeta(this.idOrName(b)),
                    d = $(b).attr("aria-describedby"),
                    a = "label[for='" + c + "'], label[for='" + c + "'] *";
                return d && (a = a + ", #" + this.escapeCssMeta(d).replace(/\s+/g, ", #")), this.errors().filter(a)
            },
            ...
            validationTargetFor: function(a) {
                return this.checkable(a) && (a = this.findByName(a.name)), $(a).not(this.settings.ignore)[0]
            },
            checkable: function(a) {
                return /radio|checkbox/i.test(a.type)
            },
            findByName: function(a) {
                return $(this.currentForm).find("[name='" + this.escapeCssMeta(a) + "']")
            },
            ...
            startRequest: function(a) {
                this.pending[a.name] || (this.pendingRequest++, $(a).addClass(this.settings.pendingClass), this.pending[a.name] = !0)
            },
            stopRequest: function(a, b) {
                this.pendingRequest--, this.pendingRequest < 0 && (this.pendingRequest = 0), delete this.pending[a.name], $(a).removeClass(this.settings.pendingClass), b && 0 === this.pendingRequest && this.formSubmitted && this.form() && 0 === this.pendingRequest ? ($(this.currentForm).trigger("submit"), this.submitButton && $("input:hidden[name='" + this.submitButton.name + "']", this.currentForm).remove(), this.formSubmitted = !1) : !b && 0 === this.pendingRequest && this.formSubmitted && ($(this.currentForm).triggerHandler("invalid-form", [this]), this.formSubmitted = !1)
            },
            previousValue: function(b, a) {
                return a = "string" == typeof a && a || "remote", $.data(b, "previousValue") || $.data(b, "previousValue", {
                    old: null,
                    valid: !0,
        ...
        classRules: function(b) {
            var c = {},
                a = $(b).attr("class");
            return a && $.each(a.split(" "), function() {
        ...
        attributeRules: function(d) {
            ...
            for (b in $.validator.methods) "required" === b ? ("" === (a = d.getAttribute(b)) && (a = !0), a = !!a) : a = e.attr(b), this.normalizeAttributeRule(c, f, b, a);
        ...
        dataRules: function(c) {
            ...
            for (a in $.validator.methods) "" === (b = e.data("rule" + a.charAt(0).toUpperCase() + a.substring(1).toLowerCase())) && (b = !0), this.normalizeAttributeRule(d, f, a, b);
            return d
        },
        staticRules: function(a) {
            var b = {},
                c = $.data(a.form, "validator");
            return c.settings.rules && (b = $.validator.normalizeRule(c.settings.rules[a.name]) || {}), b
        },
        normalizeRules: function(a, b) {
            return $.each(a, function(d, c) {
                if (!1 === c) {
                    delete a[d];
                    return
                }
                if (c.param || c.depends) {
                    ...
                    switch (typeof c.depends) {
                        case "string":
                            e = !!$(c.depends, b.form).length;
                            break;
                        case "function":
                            e = c.depends.call(b, b)
                    }
                    e ? a[d] = void 0 === c.param || c.param : ($.data(b.form, "validator").resetElements($(b)), delete a[d])
                }
            }), $.each(a, function(d, c) {
                a[d] = "function" == typeof c && "normalizer" !== d ? c(b) : c
            ...
            }), $.validator.autoCreateRanges && (null != a.min && null != a.max && (a.range = [a.min, a.max], delete a.min, delete a.max), null != a.minlength && null != a.maxlength && (a.rangelength = [a.minlength, a.maxlength], delete a.minlength, delete a.maxlength)), a
        },
        ...
        addMethod: function(a, b, c) {
            $.validator.methods[a] = b, $.validator.messages[a] = void 0 !== c ? c : $.validator.messages[a], b.length < 3 && $.validator.addClassRules(a, $.validator.normalizeRule(a))
        },
        methods: {
            required: function(b, a, d) {
                if (!this.depend(d, a)) return "dependency-mismatch";
                if ("select" === a.nodeName.toLowerCase()) {
                    var c = $(a).val();
                    return c && c.length > 0
                }
                return this.checkable(a) ? this.getLength(b, a) > 0 : null != b && b.length > 0
            },
            email: function(a, b) {
            ...
            step: function(b, c, d) {
                var e, a = $(c).attr("type"),
                    ...
                    h = !0;
                if (j) throw new Error("Step attribute on input type " + a + " is not supported.");
                return e = f(d), (f(b) > e || g(b) % g(d) != 0) && (h = !1), this.optional(c) || h
            },
            ...
            remote: function(f, a, b, c) {
                if (this.optional(a)) return "dependency-mismatch";
                c = "string" == typeof c && c || "remote";
                var g, h, e, d = this.previousValue(a, c);
                return (this.settings.messages[a.name] || (this.settings.messages[a.name] = {}), d.originalMessage = d.originalMessage || this.settings.messages[a.name][c], this.settings.messages[a.name][c] = d.message, b = "string" == typeof b && {
                    url: b
                } || b, e = $.param($.extend({
                    data: f
                }, b.data)), d.old === e) ? d.valid : (d.old = e, g = this, this.startRequest(a), (h = {})[a.name] = f, $.ajax($.extend(!0, {
                    mode: "abort",
                    ...
                    success: function(b) {
                        var e, i, j, h = !0 === b || "true" === b;
                        g.settings.messages[a.name][c] = d.originalMessage, h ? (j = g.formSubmitted, g.resetInternals(), g.toHide = g.errorsFor(a), g.formSubmitted = j, g.successList.push(a), g.invalid[a.name] = !1, g.showErrors()) : (e = {}, i = b || g.defaultMessage(a, {
                            method: c,
                            parameters: f
                        }), e[a.name] = d.message = i, g.invalid[a.name] = !0, g.showErrors(e)), d.valid = h, g.stopRequest(a, h)
                    }
                }, b)), "pending")
            }
        }
    ...
    var b, d = {};
    return $.ajaxPrefilter ? $.ajaxPrefilter(function(b, _, c) {
        var a = b.port;
        "abort" === b.mode && (d[a] && d[a].abort(), d[a] = c)
    }) : (b = $.ajax, $.ajax = function(a) {
        var e = ("mode" in a ? a : $.ajaxSettings).mode,
            c = ("port" in a ? a : $.ajaxSettings).port;
        return "abort" === e ? (d[c] && d[c].abort(), d[c] = b.apply(this, arguments), d[c]) : b.apply(this, arguments)
    }), $
})
...
jQuery("body").addClass('bodyrtl');
// document.querySelector('[data-switch-dark]').style = "display:none";
// document.querySelector('.dropdown.switecher-new').style = "display:none";
